  ...
  },
  {
    ...
    groups: [
      { label: "Paprikák", items: [
        ...
        { id:"almapap",    name:"Töltött almapaprika", img:"sav/almapap.jpg",    options:[{label:"5 kg",price:0},{label:"10 kg",price:0}] },
        { id:"cseresznyepaprika",    name:"Cseresznyepaprika", img:"sav/cseresznyepaprika.jpg",    options:[{label:"5 kg",price:0},{label:"10 kg",price:0}] },
        { id:"pepperoni",    name:"Pepperoni", img:"sav/pepperoni.jpg",    options:[{label:"5 kg",price:0},{label:"10 kg",price:0}] },
      ]},
      { label: "Uborkák", items: [
      ...
      { label: "Káposztafélék", items: [
        { id:"csala",  name:"Csalamádé",        img:"sav/vegyees.jpg",  options:[{label:"5 kg",price:3790},{label:"15 kg",price:8900}] },
        { id:"kaposztasalata",  name:"Káposztasaláta",        img:"sav/kaposztasalata.jpg",  options:[{label:"5 kg",price:3790},{label:"15 kg",price:8900}] },
  ...
  },
  {
    ...
    groups: [
      { label: "Magvak, aromák", items: [
        { id:"bananchips",     name:"Banánchips",         img:"szarazaru/bananchips.jpg",     unit:"kg", price:2990 },
