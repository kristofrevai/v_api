  ...
  return (
    '<div style="font-family:Arial,Helvetica,sans-serif;max-width:680px;margin:0 auto;color:#333;">' +
      ...
      (order.paymentMethod === "bank_transfer" ?
        '<p style="background:#fff3e6;color:#c65f00;padding:10px 14px;border-radius:8px;font-size:13px;">⚠️ Utalásos számlás rendelés (céges fiók) - a számlát csak a tényleges, kiszállított mennyiség megerősítése után szabad kiállítani.</p>'
        : "") +
    ...
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fbf8f4; padding:32px 16px;">' +
      '<tr><td align="center">' +
        '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,0.06);">' +
          ...
          // Utalásos számla esetén kiegészítő tájékoztató doboz
          (isBankTransfer ?
            '<tr><td style="padding:14px 32px 0 32px;">' +
              '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#eef4ff; border-radius:10px;"><tr>' +
                '<td style="padding:14px 16px;">' +
                  '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:1.6; color:#3457d5; margin:0;">💳 Céges fiókként a rendelést utalásos számlával adta le. Mivel a friss termékek ténylegesen kiszállított mennyisége (pl. súlya) eltérhet a megrendelttől, a számlát csak a pontos mennyiség egyeztetése után állítjuk ki és küldjük el az utalási adatokkal együtt.</p>' +
                '</td>' +
              '</tr></table>' +
            '</td></tr>'
            : "") +
...
// ─── E-mail cím megerősítő e-mail (saját, márkázott sablon Resend-en keresztül) ──
    ...
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fbf8f4; padding:32px 16px;">' +
      '<tr><td align="center">' +
        '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px; background-color:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,0.06);">' +
          ...
          '<tr><td style="padding:36px 32px 8px 32px;">' +
            '<table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 20px auto;"><tr>' +
              '<td align="center" style="width:64px; height:64px; background-color:#eef4ff; border-radius:50%; font-size:28px; line-height:64px;">✉️</td>' +
            '</tr></table>' +
            '<h1 style="font-family:Georgia, \'Times New Roman\', serif; font-size:22px; color:#1f1f1f; text-align:center; margin:0 0 16px 0;">Erősítse meg az e-mail címét</h1>' +
            '<p style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:1.7; color:#555555; text-align:center; margin:0 0 28px 0;">Köszönjük a regisztrációt! A(z) <strong style="color:#1f1f1f;">' + escapeHtml(email) + '</strong> e-mail cím megerősítéséhez kattintson az alábbi gombra.</p>' +
          '</td></tr>' +

          '<tr><td align="center" style="padding:0 32px 32px 32px;">' +
            '<table role="presentation" cellpadding="0" cellspacing="0"><tr>' +
              '<td align="center" style="border-radius:50px; background-color:#ff7a18;">' +
                '<a href="' + verifyLink + '" target="_blank" style="display:inline-block; padding:15px 38px; font-family:Arial, Helvetica, sans-serif; font-size:15px; font-weight:bold; color:#ffffff; text-decoration:none; border-radius:50px;">E-mail cím megerősítése</a>' +
              '</td>' +
            '</tr></table>' +
          '</td></tr>' +
          ...
          '<tr><td style="padding:0 32px 28px 32px;">' +
            '<p style="font-family:Arial, Helvetica, sans-serif; font-size:12.5px; line-height:1.6; color:#aaaaaa; text-align:center; margin:0;">Ha a gomb nem működik, másolja be ezt a linket a böngészőjébe:<br>' +
              '<a href="' + verifyLink + '" style="color:#ff7a18; word-break:break-all;">' + verifyLink + '</a></p>' +
          '</td></tr>' +

          '<tr><td style="padding:0 32px 32px 32px;">' +
            '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#fff8e1; border-radius:10px;"><tr>' +
              '<td style="padding:14px 16px;">' +
                '<p style="font-family:Arial, Helvetica, sans-serif; font-size:13px; line-height:1.6; color:#7a5f3d; margin:0;">⚠️ Ha Ön nem regisztrált nálunk, egyszerűen hagyja figyelmen kívül ezt az e-mailt.</p>' +
              '</td>' +
            '</tr></table>' +
          '</td></tr>' +
